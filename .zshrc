...
zplugin ice wait'!0'; zplugin light cm-hirano-shigetoshi/snippet
zplugin ice wait'!0' as"program" pick"bin/fzfyml"; zplugin light cm-hirano-shigetoshi/fzfyml
zplugin ice wait'!0' src"select-files.zsh"; zplugin light cm-hirano-shigetoshi/select-files
zplugin ice wait'!0' src"history.zsh"; zplugin light cm-hirano-shigetoshi/command-history
